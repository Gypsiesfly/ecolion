    ...
    <footer className="bg-white py-8">
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
          ...
          <Link
            href="/contact"
            className="flex items-center gap-3 bg-white px-6 py-3 hover:bg-[#FDFDFD] transition-colors group"
          >
            <span className="text-black font-medium transition-colors">Want to know more?</span>
            <div className="bg-black p-2 flex items-center justify-center transition-colors">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-black p-2 hover:opacity-80 transition-opacity"
            >
